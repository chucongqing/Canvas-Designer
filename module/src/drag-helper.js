  ...
  mousedown: function (e) {
    ...
    if (points.length) {
      ...
      if (p[0] === "rect") {
        ...
        if (
          dHelper.isPointInPath(x, y, point[0] + point[2], point[1] + point[3])
        ) {
      ...
      if (p[0] === "image") {
        ...
        if (
          dHelper.isPointInPath(x, y, point[1] + point[3], point[2] + point[4])
        ) {
          g.pointsToMove = "stretch-last";
        }
      }
