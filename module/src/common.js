...
export function getContext(id) {
    ...
    const {lineWidth, strokeStyle, fillStyle, font} = globalCfg;
...
export var context = getContext('main-canvas'),
    tempContext = getContext('temp-canvas');
export var canvas = tempContext.canvas;
export var isTouch = 'createTouch' in window;
...
export var common = {
    ...
    absoluteShortened: function() {
        const {points, textarea} = globalCfg;
        var output = '',
